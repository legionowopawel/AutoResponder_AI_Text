...
def detect_topic(body_text: str) -> str:
    ...
    res = call_deepseek(
        "Detektor tematu notarialnego (jedna etykieta lub UNKNOWN)", prompt, MODEL_BIZ
    )
    if not res:
        return "UNKNOWN"
...
def build_biznes_section(body: str, sender_name: str = "", gender: str = "N", imie: str = "__BRAK__", nazwisko: str = "__BRAK__") -> dict:
    """
